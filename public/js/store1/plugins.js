...
!function(e, t) {
    ...
    function X(e) {
        ...
        let x = !0;
        u.matches(n.focusableElements) && (x = !1,
        ...
        !o.touchStartForcePreventDefault && !E || u.isContentEditable || p.preventDefault(),
    ...
    function Y(e) {
        ...
        v > 0 ? (y && !x && i.currentTranslate > (r.centeredSlides ? s.minTranslate() - s.size / 2 : s.minTranslate()) && s.loopFix({
            direction: "prev",
            setTranslate: !0,
            activeSlideIndex: 0
        }),
        i.currentTranslate > s.minTranslate() && (E = !1,
        r.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + v) ** S))) : v < 0 && (y && !x && i.currentTranslate < (r.centeredSlides ? s.maxTranslate() + s.size / 2 : s.maxTranslate()) && s.loopFix({
            direction: "next",
            setTranslate: !0,
    ...
    if ("undefined" !== typeof window && window.addEventListener) {
        ...
        n = function() {
            ...
            for (g = 0; g < h.length; g += 1) {
                ...
                b.open("GET", a),
                b.send(),
                r += 1))) : b ? a.length && e[a] && setTimeout(l({
                    useEl: h[g],
                    base: a,
                    hash: m,
                    isXlink: k
...
!function(a) {
    ...
    function c(d, e) {
        ...
        m.length || (console.warn("isInViewport: The viewport selector you have provided matches no element on page."),
        ...
        return k.tolerance = ~~Math.round(parseFloat(k.tolerance)),
        k.tolerance < 0 && (k.tolerance = n + k.tolerance),
        Math.abs(i) >= o ? l : l = k.tolerance ? !!(g <= k.tolerance && h >= k.tolerance) : !!(h > 0 && n >= g)
    }
    var d = function(b) {
    ...
    try {
        a.fn.do = function(a) {
            return console.warn("isInViewport: .do causes issues in IE and some browsers since its a reserved. Use $.fn.run instead i.e., $(el).run(fn)."),
            d(a)
        }
        ,
        a.fn.run = d
