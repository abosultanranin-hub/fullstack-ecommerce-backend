...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/store1/normalize.css') }}">
  <link rel="stylesheet" href="{{ asset('css/store1/vendor.css') }}">
  <link rel="stylesheet" href="{{ asset('css/store1/style.css') }}">
  ...
  <!-- script
    ================================================== -->
  <script src="{{ asset('js/store1/modernizr.js') }}"></script>
</head>
...
<body>
  ...
  <script src="{{ asset('js/store1/jquery-1.11.0.min.js') }}"></script>
<script src="{{ asset('js/store1/plugins.js') }}"></script>
<script src="{{ asset('js/store1/script.js') }}"></script>
</body>
